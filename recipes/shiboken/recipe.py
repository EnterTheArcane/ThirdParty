...
class Recipe(RecipeBase):
    ...
    def generate(self):
        ...
        if cross_building(self):
            ...
            # ships, so Development is reported missing. Point it at a versioned-named copy (the
            # same helper the cross path uses); the import lib still references python3.dll.
