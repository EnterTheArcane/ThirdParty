...
class RecipeBase(ABC, Generic[TOptions]):
    ...
    #: Set by the one toolchain provider recipe that --compiler auto-selection tries
    #: first; the rest are tried alphabetically when it rejects the target.
    default_toolchain: bool = False
